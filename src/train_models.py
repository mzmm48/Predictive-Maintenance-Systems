...
# Hinweis: create_models(...) ist aktuell auskommentiert; das Skript erzeugt aber bereits X_test/y_test Artefakte und prüft NaNs
...
# 5) Train/Test Split: erzeugt reproduzierbaren Split; stratify hält Klassenverteilung in Train/Test stabil
...
# 7) Modelle definieren: definiert die zu trainierenden Modelle mit Basishyperparametern
models = {
...
# Sanity-Check: stellt sicher, dass das Preprocessing keine NaNs erzeugt (z. B. durch fehlendes Type-Mapping)
